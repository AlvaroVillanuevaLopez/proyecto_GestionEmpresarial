 ...
 */
class getHistorialSubidasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistorialSubidasRepository' shared autowired service.
     *
     * @return \App\Repository\HistorialSubidasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistorialSubidasRepository.php';

        return $container->privates['App\\Repository\\HistorialSubidasRepository'] = new \App\Repository\HistorialSubidasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
