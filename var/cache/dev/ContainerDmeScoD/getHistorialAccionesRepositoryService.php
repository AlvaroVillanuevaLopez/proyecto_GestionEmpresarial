 ...
 */
class getHistorialAccionesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistorialAccionesRepository' shared autowired service.
     *
     * @return \App\Repository\HistorialAccionesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistorialAccionesRepository.php';

        return $container->privates['App\\Repository\\HistorialAccionesRepository'] = new \App\Repository\HistorialAccionesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
