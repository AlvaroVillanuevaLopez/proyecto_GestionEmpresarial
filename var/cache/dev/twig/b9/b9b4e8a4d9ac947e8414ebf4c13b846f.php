    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["empresa"]) {
            ...
            yield "</td>
                <td>";
            // line 29
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["empresa"], "passwordEncriptada", [], "any", false, false, false, 29), "html", null, true);
            yield "</td>
                <td>";
            // line 30
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["empresa"], "remotePath", [], "any", false, false, false, 30), "html", null, true);
            yield "</td>
                <td>
                    <a href=\"";
            // line 32
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_empresa_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["empresa"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            yield "\">show</a>
                    <a href=\"";
            // line 33
...
{% block body %}
    ...
    <a href=\"{{ path('app_empresa_new') }}\">Create new</a>
{% endblock %}
", "empresa/index.html.twig", "C:\\Users\\izano\\PRACTICAS DAW 2026\\Sistema_de_Gestion_Documental_SFTP\\templates\\empresa\\index.html.twig");
    }
}
