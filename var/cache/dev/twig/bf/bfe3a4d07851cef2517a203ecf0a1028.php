...
class __TwigTemplate_013c6557db2080b5c136aac2a642dace extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "empresa/_form.html.twig"));
    ...
    <button id=\"cartero\">";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "CREAR")) : ("CREAR")), "html", null, true);
        yield "</button>
";
        // line 4
...
";
    ...
    {{ form_widget(form) }}
    <button id=\"cartero\">{{ button_label|default('CREAR') }}</button>
{{ form_end(form) }}
", "empresa/_form.html.twig", "C:\\Users\\alvar\\OneDrive\\Escritorio\\VISUAL-STUDIO-CODE\\proyecto_GestionEmpresarial\\templates\\empresa\\_form.html.twig");
    }
}
