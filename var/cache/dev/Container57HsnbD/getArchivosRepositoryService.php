 ...
 */
class getArchivosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArchivosRepository' shared autowired service.
     *
     * @return \App\Repository\ArchivosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArchivosRepository.php';

        return $container->privates['App\\Repository\\ArchivosRepository'] = new \App\Repository\ArchivosRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
